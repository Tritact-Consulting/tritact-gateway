    ...
    <div class="row">
        <div class="col-lg-12 col-12">
            <div class="box">
                ...
                @endif
                <!-- /.box-header -->
                <form class="form" enctype="multipart/form-data" method="post" action="{{ route('certifications.update', $data->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="certification_category" id="certification" class="form-control select2" required>
